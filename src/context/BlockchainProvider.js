...
const BlockchainProvider = ({ children }) => {
  ...
  //       console.log("Number of Tickets: ", num);
  //       setNumTickets(num);
  //     }
  //   };
  //   fetchNumTickets();
  ...
  //   if (web3 && accounts.length > 0) {
  //     const loadContracts = async () => {
  //       const mokTokenInstance = await getMOKTokenInstance(web3, "0x5a54227Ca6A8A8a58bf6649A8034bBE891a99e8f");
  //       const lotteryInstance = await getLotteryInstance(web3, "0x08104599da66A6d7ab2b6013123657740FDA1b80");
  
  //       console.log("MOKToken instance:", mokTokenInstance);
  //       console.log("Lottery instance:", lotteryInstance);
